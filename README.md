...
**This code is meant to demonstrate a simple digital evnvelope method and is not recommended to be used for confidential files. The app itself designed to be ran in Android Studio via cloning the repository. Trying in any other environment might cause unintended errors.** 
